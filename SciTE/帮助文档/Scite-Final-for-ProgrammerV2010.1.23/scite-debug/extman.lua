...
function OnSave(file)
	...
	--output:AppendText('Scite/Lua scite_OnSave\n')
...
local wordchars = '[A-Za-zА-Эа-я]'  -- wuz %w
...
--require ("SciTEHexEdit")  -- use this way, lua file should be located the same folder as Scite.exe or extman.lua
...
-- Подсветк?парных тего??HTML
dofile (props["SciteDefaultHome"].."\\tools\\highlighting_paired_tags.lua")

-- Подсветк?линков ?тексте ?открытие их ?броузере пр?клик??зажаты?Ctrl
