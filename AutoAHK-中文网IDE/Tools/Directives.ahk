...
, g_AutoAHK
, g_AutoAHKPath := A_ScriptDir . "\..\AutoAHK.ahk"
, g_StrRequireAdmin
, g_StrRequireVista
, g_StrRequire32bit
, g_StrRequire64bit
...
Gui Add, Tab3, x8 y8 w334 h424 -Wrap, 常用|速度|热键|其它|需要|包含
...
Gui Tab
Gui Add, Button, gGenerateCode x76 y444 w84 h24 +Default, 确定(&O)
Gui Add, Button, gGuiClose x166 y444 w84 h24, 取消(&C)
Gui Add, Button, gStartHelp x256 y444 w84 h24, 帮助(&H)

Gui Show, w349 h481, 脚本指令
...
g_AutoAHK := InStr(DllCall("GetCommandLine", "Str"), " /AutoAHK")
Return
...
NotifyAutoAHK:
    SendMessage 10000, 3, hEdtIPC,, % "ahk_id " . GetAutoAHKHandle(g_AutoAHKPath)
Return
...
GenerateCode:
    ...
    If (g_AutoAHK && !GetKeyState("Shift", "P")) {
